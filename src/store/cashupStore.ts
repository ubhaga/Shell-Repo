...
function monthlyToRow(f: MonthlyBranchFigures) {
  return {
    ...
    explanation_bank_charges: f.explanationBankCharges,
    cash_connect_invoice_incl_vat: f.cashConnectInvoiceInclVat,
    bank_charges_adj: f.bankChargesAdj,
    cc_xero: f.ccXero,
    cc_unbanked_deposit: f.ccUnbankedDeposit,
    petty_cash_recon: f.pettyCashRecon,
    petty_cash_xero: f.pettyCashXero,
    petty_cash_unbanked_deposit: f.pettyCashUnbankedDeposit,
    eft_xero: f.eftXero,
    eft_unbanked_deposit: f.eftUnbankedDeposit,
    notes: f.notes,
...
function rowToMonthly(r: Record<string, unknown>): MonthlyBranchFigures {
  return {
    ...
    explanationBankCharges: (r.explanation_bank_charges as string) ?? '',
    cashConnectInvoiceInclVat: Number(r.cash_connect_invoice_incl_vat ?? 0),
    bankChargesAdj: Number(r.bank_charges_adj ?? 0),
    ccXero: Number(r.cc_xero ?? 0),
    ccUnbankedDeposit: Number(r.cc_unbanked_deposit ?? 0),
    pettyCashRecon: Number(r.petty_cash_recon ?? 0),
    pettyCashXero: Number(r.petty_cash_xero ?? 0),
    pettyCashUnbankedDeposit: Number(r.petty_cash_unbanked_deposit ?? 0),
    eftXero: Number(r.eft_xero ?? 0),
    eftUnbankedDeposit: Number(r.eft_unbanked_deposit ?? 0),
    notes: r.notes as string,
