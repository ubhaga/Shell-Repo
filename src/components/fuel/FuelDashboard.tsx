          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="bg-muted/40 border-b">
                ...
                <th className="px-3 py-2 text-right font-medium">POS Pump (L)</th>
                <th className="px-3 py-2 text-right font-medium">Tank Sales (L)</th>
                <th className="px-3 py-2 text-right font-medium">Tank vs Pump</th>
                <th className="px-3 py-2 text-right font-medium">Meter Actual (L)</th>
                <th className="px-3 py-2 text-right font-medium">Meter vs POS</th>
